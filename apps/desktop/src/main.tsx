...
function ModelRow({ label, value, warn = false, empty }: { label: string; value: string; warn?: boolean; empty: string }) { return <div className="model-row"><span>{label}</span><strong className={warn ? "warn" : ""}>{value || empty}</strong></div>; }
