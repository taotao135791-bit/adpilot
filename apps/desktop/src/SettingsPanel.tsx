...
type SettingsTab = "general" | "models" | "computer" | "about";

export function SettingsPanel({ open, data, onClose, onSaved }: { open: boolean; data: SettingsData | undefined; onClose: () => void; onSaved: (data: SettingsData) => void }) {
