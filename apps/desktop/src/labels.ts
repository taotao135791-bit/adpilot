...
const zh = {
  ...
  runBusyElsewhere: "其他会话运行中",
  runBusyElsewhereHint: "另一会话正在运行，请返回该会话停止，或等待它完成。",
  launch: "启动调查",
  send: "发送",
  stopRun: "停止运行",
  stoppingRun: "正在停止",
  stopRunError: "无法停止当前运行",
  configureModel: "配置模型",
  you: "你",
  liveOperations: "实时",
  executionStack: "运行状态",
...
const en: Record<keyof typeof zh, string> = {
  ...
  runBusyElsewhere: "Another chat is running",
  runBusyElsewhereHint: "Return to the running chat to stop it, or wait for it to finish.",
  launch: "Start investigation",
  send: "Send",
  stopRun: "Stop run",
  stoppingRun: "Stopping",
  stopRunError: "Could not stop the active run",
...
const pluginsZh = {
  ...
  candidateWorkGroup: "工作与设计候选",
  candidateAdvertisingGroup: "广告平台候选",
  candidateOnly: "不可安装",
...
const pluginsEn: Record<keyof typeof pluginsZh, string> = {
  ...
  candidateWorkGroup: "Work and design candidates",
  candidateAdvertisingGroup: "Advertising platform candidates",
...
const workspaceZh = {
  ...
  projectChooseRoot: "选择文件夹…",
  projectChoosingRoot: "正在打开系统选择器…",
  projectRootsNativeHint: "必填；可用系统选择器添加目录，也可手动填写。代码、终端和 Git 只允许访问这些目录。",
  projectRootPickerFailed: "无法打开系统文件夹选择器，请手动填写绝对路径。",
  projectCreate: "创建项目",
  archiveProject: "归档项目",
  ...
  skillsSearchPlaceholder: "搜索名称、说明、发布者或触发词",
  skillsSourceFilter: "按来源筛选技能",
  skillsSourceAll: "全部来源",
  skillsNoMatches: "没有匹配的技能",
  skillsNoMatchesBody: "换一个关键词或来源筛选条件。",
  skillTriggers: "触发词",
  ...
  decisionQueue: "建议记录",
  decisionQueueEmpty: "还没有建议记录",
  decisionQueueEmptyBody: "这里只保存建议、理由、风险与预案；记录本身不会修改广告账户。",
  decisionReadOnlyNotice: "此处仅保存建议，不执行账户操作。真实变更必须通过独立审批、Computer Use 和结果验证流程。",
  decisionNew: "记录建议",
  decisionCreateTitle: "记录新建议",
  ...
  decisionObservationWindowLabel: "计划观察窗口(可选)",
  decisionObservationWindowPlaceholder: "例如:3 天 / 2 个转化周期",
  decisionRollbackPlanLabel: "拟定回滚方案(可选)",
  decisionCreate: "保存建议",
  decisionRationale: "理由",
  decisionRisks: "风险",
  decisionEvidence: "证据",
  decisionDuplicate: "已存在相同建议，已在下方高亮",
  decisionStatusProposed: "建议 · 未执行",
  decisionStatusApproved: "旧评审标记 · 未执行",
  decisionStatusExecuted: "旧状态标记 · 执行未验证",
  decisionStatusObserving: "旧状态标记 · 观察未验证",
  decisionStatusSuccessful: "旧状态标记 · 结果未验证",
  decisionStatusFailed: "旧状态标记 · 结果未验证",
  decisionStatusReverted: "旧状态标记 · 回滚未验证"
} as const;
...
const workspaceEn: Record<keyof typeof workspaceZh, string> = {
  ...
  projectChooseRoot: "Choose folder…",
  projectChoosingRoot: "Opening system chooser…",
  projectRootsNativeHint: "Required; add a directory with the system chooser or enter it manually. Code, terminal, and Git stay confined to these directories.",
  projectRootPickerFailed: "Could not open the system folder chooser. Enter an absolute path manually.",
  ...
  terminalRunAnyway: "Confirm and run",
  ...
  skillsSearchPlaceholder: "Search names, descriptions, publishers or triggers",
  skillsSourceFilter: "Filter skills by source",
  skillsSourceAll: "All sources",
  skillsNoMatches: "No matching skills",
  skillsNoMatchesBody: "Try another search or source filter.",
  ...
  decisionQueue: "Decision ledger",
  decisionQueueEmpty: "No proposals recorded",
  decisionQueueEmptyBody: "This ledger stores recommendations, rationale, risks, and plans; a record never changes an advertising account.",
  decisionReadOnlyNotice: "This ledger records recommendations only; it does not execute account changes. A real change requires the separate approval, Computer Use, and verification flow.",
  decisionNew: "Record proposal",
  decisionCreateTitle: "Record a proposal",
  ...
  decisionObservationWindowLabel: "Planned observation window (optional)",
  decisionObservationWindowPlaceholder: "e.g. 3 days / 2 conversion cycles",
  decisionRollbackPlanLabel: "Proposed rollback plan (optional)",
  decisionCreate: "Save proposal",
  decisionRationale: "Rationale",
  decisionRisks: "Risks",
  decisionEvidence: "Evidence",
  decisionDuplicate: "An identical recommendation already exists — highlighted below",
  decisionStatusProposed: "Proposal · not executed",
  decisionStatusApproved: "Legacy review marker · not executed",
  decisionStatusExecuted: "Legacy marker · execution unverified",
  decisionStatusObserving: "Legacy marker · observation unverified",
  decisionStatusSuccessful: "Legacy marker · outcome unverified",
  decisionStatusFailed: "Legacy marker · outcome unverified",
  decisionStatusReverted: "Legacy marker · rollback unverified"
};
