...
- `~/.adpilot/skills/ads/references/image-providers.md`: API setup and pricing
- `~/.adpilot/skills/ads/references/brand-dna-template.md`: Brand injection schema
- `~/.adpilot/skills/ads/references/meta-creative-specs.md`: Safe zone for 9:16
- `~/.adpilot/skills/ads/references/tiktok-creative-specs.md`: Safe zone constraints
