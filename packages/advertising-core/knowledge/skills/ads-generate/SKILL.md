...
`~/.adpilot/skills/ads/references/<file>.md`, `../ads/references/<file>.md`,
...
These `/ads ...` entries are AdPilot routing shorthand, not shell commands.
...
Load `~/.adpilot/skills/ads/references/image-providers.md` to confirm:
...
- `~/.adpilot/skills/ads/references/meta-creative-specs.md`
- `~/.adpilot/skills/ads/references/google-creative-specs.md`
- `~/.adpilot/skills/ads/references/tiktok-creative-specs.md`
- `~/.adpilot/skills/ads/references/linkedin-creative-specs.md`
- `~/.adpilot/skills/ads/references/youtube-creative-specs.md`
- `~/.adpilot/skills/ads/references/microsoft-creative-specs.md`
...
- `~/.adpilot/skills/ads/references/image-providers.md`: provider config, pricing, limits
- `~/.adpilot/skills/ads/references/[platform]-creative-specs.md`: per-platform specs
- `~/.adpilot/skills/ads/references/brand-dna-template.md`: brand injection schema
